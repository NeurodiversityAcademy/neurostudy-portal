    ...
    <div className={styles.container}>
      ...
      <div className={styles.detailWrapper}>
        ...
        <div className={styles.detailContainer}>
          {' '}
          {courses.map((course) => (
            <div key={course.id} className={styles.blogItem}>
              {' '}
              {/* 标题 */}
              <Typography variant={TypographyVariant.H2}>
                <section id='section1'>Course Overview</section>
              </Typography>
              <Typography variant={TypographyVariant.Body3}>
                {course.Overview}
              </Typography>
              <Typography variant={TypographyVariant.H2}>
                <section id='section2'>Entry Requirements</section>
              </Typography>
              <Typography variant={TypographyVariant.Body3}>
                {course.Requirements}
              </Typography>
              <Typography variant={TypographyVariant.H2}>
                <section id='section3'>Tuition&Fees</section>
              </Typography>
              <Typography variant={TypographyVariant.Body3}>
                {course.Fees}
              </Typography>
