...
describe('CourseDetailsBodyText', () => {
  ...
  it('renders tuition fees link only for tuitionFees id', () => {
  ...
  it('does not render tuition fees link for other ids', () => {
    render(<CourseDetailsBodyText id='overview' data={'Overview text'} />);

    expect(screen.queryByRole('link', { name: /view tuition fees/i })).not.toBeInTheDocument();
  });
