      ...
      <div className={styles.factGrid}>
        <div className={styles.gridItem}>
          ...
          <Typography variant={TypographyVariant.Body1} color='var(--BondBlackVariant)'>
            Increase in students starting university with a neurological condition — rising from
            4,054 in 2021 to 10,665 in 2024.
          </Typography>
        </div>
        <div className={styles.gridItem}>
          <Typography variant={TypographyVariant.H1} color='var(--BondBlack)'>
          ...
          <Typography variant={TypographyVariant.Body1} color='var(--BondBlackVariant)'>
            Improvement in retention is linked to access to adjustments such as extra time, flexible
            deadlines, coaching, and assistive technology.
          </Typography>
        </div>
        <div className={styles.gridItem}>
          <Typography variant={TypographyVariant.H1} color='var(--BondBlack)'>
          ...
          <Typography variant={TypographyVariant.Body1} color='var(--BondBlackVariant)'>
            Neurodivergent students do not formally disclose at enrolment, often due to stigma or
            lack of diagnosis.
          </Typography>
        </div>
      </div>
