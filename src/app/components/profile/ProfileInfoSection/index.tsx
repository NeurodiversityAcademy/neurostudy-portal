...
import { EMAIL_REGEX, FORM_ELEMENT_COL_WIDTH, NAME_REGEX } from '@/app/utilities/constants';
...
import { forwardRef, ForwardRefExoticComponent, RefAttributes, useImperativeHandle } from 'react';
import { ProfileSectionRef } from '@/app/interfaces/Profile';

const ProfileInfoSection: ForwardRefExoticComponent<RefAttributes<ProfileSectionRef>> =
