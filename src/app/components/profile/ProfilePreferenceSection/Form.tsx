...
import { PREFERENCE_FIELDS, PROFILE_FIELD_OPTIONS } from '@/app/utilities/profile/constants';
...
> = forwardRef<ProfileSectionRef, ProfileSectionFormProps>(({ onSubmit, onCancel }, ref) => {
  ...
  const methods: UseFormReturn<UserPreferenceProps> = useForm<UserPreferenceProps>({
    mode: 'onBlur',
  });
