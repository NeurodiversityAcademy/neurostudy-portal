...
describe('Typography', () => {
  it('renders children text', () => {
    render(
      <Typography variant={TypographyVariant.Body1}>Hello World</Typography>,
    );
  ...
  it('renders an h1 tag for H1 variant', () => {
    render(
      <Typography variant={TypographyVariant.H1}>Heading</Typography>,
    );
  ...
  it('renders an h2 tag for H2 variant', () => {
    render(
      <Typography variant={TypographyVariant.H2}>Sub Heading</Typography>,
    );
  ...
  it('renders an h3 tag for H3 variant', () => {
    render(
      <Typography variant={TypographyVariant.H3}>Minor</Typography>,
    );
  ...
  it('renders a span for Body1 variant', () => {
    render(
      <Typography variant={TypographyVariant.Body1}>Body</Typography>,
    );
  ...
  it('renders a span for Body2 variant', () => {
    render(
      <Typography variant={TypographyVariant.Body2}>Body2</Typography>,
    );
  ...
  it('renders a span for Body2Strong variant', () => {
    render(
      <Typography variant={TypographyVariant.Body2Strong}>Bold</Typography>,
    );
  ...
  it('renders a span for Body3 variant', () => {
    render(
      <Typography variant={TypographyVariant.Body3}>Small</Typography>,
    );
  ...
  it('renders a span for LABELtext variant', () => {
    render(
      <Typography variant={TypographyVariant.LABELtext}>Label</Typography>,
    );
  ...
  it('renders a span for BenefitTabText variant', () => {
    render(
      <Typography variant={TypographyVariant.BenefitTabText}>Tab</Typography>,
    );
  ...
  it('warns for unmapped color tokens in non-production', () => {
    ...
    expect(warnSpy).toHaveBeenCalledWith(
      expect.stringContaining('Unmapped color prop'),
    );
    warnSpy.mockRestore();
  });
