...
export default function assertUserProps(user: UserProps): asserts user is UserProps {
  if (!user || typeof user !== 'object') {
    throwError(`Invalid prop 'user' supplied, expected an object with key-value pairs.`);
  }
