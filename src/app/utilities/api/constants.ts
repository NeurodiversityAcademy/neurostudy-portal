...
export const DEFAULT_SERVER_ERROR_MESSAGE = 'Server failed to handle the response.';
export const DEFAULT_SERVER_ERROR_RES = {
  name: DEFAULT_SERVER_ERROR_NAME,
  message: DEFAULT_SERVER_ERROR_MESSAGE,
};

export const RETURN_DEFAULT_ERROR_MESSAGE = process.env.NODE_ENV === 'production';
