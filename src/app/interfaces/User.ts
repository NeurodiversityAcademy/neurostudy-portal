...
import { DEFAULT_USER, USER_TABLE_PARTITION_ID } from '../utilities/auth/constants';

type RootUserProps = typeof DEFAULT_USER;
export type UserProps<K extends keyof RootUserProps = keyof RootUserProps> = Partial<{
